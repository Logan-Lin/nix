    ...
    programs.claude-code = {
      ...
      context = ''
        ...
        2. For any natural language text content, such as notes, reports, papers, messages, and code comments, follow the detailed rules below
          ...
          - Do not invent hyphenated compound words, whether they join two words or more. Rephrase them as plain words, for example write "a value smaller than the limit" instead of "a smaller-than-the-limit value". Only compounds already widely recognized in standard usage, such as "real-world" or "state-of-the-art", are acceptable
      ...
      commands = {
        ...
        polish = ''
          ...
          - Replace invented hyphenated compound words, whether they join two words or more, with plain phrasing, for example "a value smaller than the limit" instead of "a smaller-than-the-limit value". Leave only compounds already widely recognized in standard usage, such as "real-world" or "state-of-the-art", unchanged
